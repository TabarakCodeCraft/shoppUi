...
// node_modules/react-modal-sheet/dist/index.mjs
...
function rebaseAxisConstraints(layout2, constraints2) {
  const relativeConstraints = {};
  if (constraints2.min !== void 0) {
    relativeConstraints.min = constraints2.min - layout2.min;
  }
  if (constraints2.max !== void 0) {
    relativeConstraints.max = constraints2.max - layout2.min;
  }
...
var $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c = typeof document !== "undefined" ? (0, import_react47.default).useLayoutEffect : () => {
};
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react50.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react50.default).createContext(false);
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react50.useContext)($b5e257d569688ac6$var$SSRContext);
  let ref = (0, import_react50.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, import_react50.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 ? void 0 : (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id3 = (0, import_react50.default).useId();
  let [didSSR] = (0, import_react50.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id3}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react50.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react50.default)["useSyncExternalStore"] === "function")
    return (0, import_react50.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, import_react50.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
var $ea8dcbcb9ea1b556$var$RouterContext = (0, import_react52.createContext)({
  isNative: true,
...
var useIsomorphicLayoutEffect2 = IS_SSR ? import_react64.useEffect : import_react64.useLayoutEffect;
...
function useEventCallbacks(isOpen, callbacks) {
  const prevOpen = usePrevious(isOpen);
  const didOpen = (0, import_react64.useRef)(false);
  const handleAnimationComplete = (0, import_react64.useCallback)(() => {
    var _a, _b, _c, _d;
    if (!didOpen.current) {
...
function useDimensions() {
  const [dimensions, setDimensions] = (0, import_react64.useState)({ height: 0, width: 0 });
...
function useEffectEvent(handler) {
  const handlerRef = (0, import_react64.useRef)();
  useIsomorphicLayoutEffect2(() => {
...
function useDragConstraints() {
  const constraintsRef = (0, import_react64.useRef)(null);
  const onMeasureDragConstraints = (0, import_react64.useCallback)(() => constraints, []);
  return { constraintsRef, onMeasureDragConstraints };
}
var SheetContext = (0, import_react64.createContext)(
  void 0
);
var useSheetContext = () => {
  const context = (0, import_react64.useContext)(SheetContext);
  if (!context)
    throw Error("Sheet context error");
  return context;
};
var SheetScrollerContext = (0, import_react64.createContext)(void 0);
function SheetScrollerContextProvider({
  children
}) {
  const sheetContext = useSheetContext();
  const [disableDrag, setDisableDrag] = (0, import_react64.useState)(!!sheetContext.disableDrag);
...
var useSheetScrollerContext = () => {
  const context = (0, import_react64.useContext)(SheetScrollerContext);
  if (!context)
...
function preventScrollMobileSafari() {
  ...
  const restoreStyles = $ff5963eb1fccf552$export$e08e3b67e392101e(
    setStyle(
      document.documentElement,
      "paddingRight",
      `${window.innerWidth - document.documentElement.clientWidth}px`
  ...
  window.scrollTo(0, 0);
  const removeEvents = $ff5963eb1fccf552$export$e08e3b67e392101e(
...
function scrollIntoView(target) {
  ...
  while (target && target !== root) {
    const scrollable = $62d8ded9296f3872$export$cfa2225e87938781(target);
...
var Sheet = (0, import_react64.forwardRef)(
  ({
    onOpenStart,
    onOpenEnd,
    onClose,
    ...
    const sheetRef = (0, import_react64.useRef)(null);
    const indicatorRotation = useMotionValue(0);
    const { height: windowHeight } = useDimensions();
    const shouldReduceMotion = useReducedMotion();
    const reduceMotion = Boolean(prefersReducedMotion2 || shouldReduceMotion);
    const animationOptions = {
      type: "tween",
    ...
    const callbacks = (0, import_react64.useRef)({
      onOpenStart,
      onOpenEnd,
      onCloseStart,
      onCloseEnd
    ...
    const dragProps = (0, import_react64.useMemo)(() => {
      const dragProps2 = {
        drag: "y",
        dragElastic: 0,
        dragMomentum: false,
    ...
    const sheet = import_react64.default.createElement(SheetContext.Provider, { value: context }, import_react64.default.createElement(
      motion.div,
      {
        ...rest,
        ref,
      ...
      import_react64.default.createElement(AnimatePresence, null, isOpen ? import_react64.default.createElement(SheetScrollerContextProvider, null, import_react64.Children.map(
        children,
        (child, i) => (0, import_react64.cloneElement)(child, { key: `sheet-child-${i}` })
      )) : null)
    ));
    if (IS_SSR)
      return sheet;
    return (0, import_react_dom.createPortal)(sheet, mountPoint ?? document.body);
  }
);
Sheet.displayName = "Sheet";
var sheet_default = Sheet;
var SheetContainer = (0, import_react64.forwardRef)(
...
var SheetContent = (0, import_react64.forwardRef)(
...
var SheetHeader = (0, import_react64.forwardRef)(
  ({ children, style, disableDrag, ...rest }, ref) => {
    ...
    return import_react64.default.createElement(
      ...
      children || import_react64.default.createElement("div", { className: "react-modal-sheet-header", style: styles_default.header }, import_react64.default.createElement(
        motion.span,
        {
...
var SheetBackdrop = (0, import_react64.forwardRef)(
...
var SheetScroller = (0, import_react64.forwardRef)(
...
//# sourceMappingURL=react-modal-sheet.js.map
